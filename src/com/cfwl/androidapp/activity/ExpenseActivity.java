...
public class ExpenseActivity extends Activity {
	...
	private Spinner sp_carCode, sp_driverName,expense_type;
	// 是否支付
	private CheckBox cb_pay;
	private EditText et_payPerson, et_totalHours, et_workPlace, et_workUnit;
	...
	private void initView() {
		...
		lv.setAdapter(new ArrayAdapter<String>(ExpenseActivity.this, R.layout.item_text, AllModel.leftList));
	...
	protected void initsp_carCode() {
		...
		ArrayAdapter<String> driverNameAdapter = new ArrayAdapter<String>(ExpenseActivity.this,
		...
		sp_driverName = (Spinner) findViewById(R.id.sp_driver);
		...
		ArrayList<String> expense_types = new ArrayList<String>();
		expense_types.add("饭钱");
		expense_types.add("邮费");
		expense_types.add("过路费");
		expense_types.add("修理费");
		expense_types.add("住宿费");

		ArrayAdapter<String> expense_typeAdapter = new ArrayAdapter<String>(ExpenseActivity.this,
				android.R.layout.simple_spinner_item, expense_types);
		expense_typeAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

		expense_type = (Spinner) findViewById(R.id.sp_expense_type);
		expense_type.setAdapter(expense_typeAdapter);

		expense_type.setOnItemSelectedListener(new OnItemSelectedListener() {
			// parent： 为控件Spinner view：显示文字的TextView position：下拉选项的位置从0开始
			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				parent.getAdapter();
	...
	protected void showTimePickDlg(int top) {
		...
		TimePickerDialog datePickerDialog = new TimePickerDialog(ExpenseActivity.this,
				calendar.get(Calendar.HOUR_OF_DAY), new OnTimeSetListener() {
					@Override
					public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
						ExpenseActivity.this.et_selectTime.setText(hourOfDay + ":" + minute);
					}
	...
	protected void showDatePickDlg(int top) {
		Calendar calendar = Calendar.getInstance();
		MyDataPick datePickerDialog = new MyDataPick(ExpenseActivity.this, new OnDateSetListener() {
			@Override
			public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
				ExpenseActivity.this.et_selectDate.setText(year + "-" + monthOfYear + "-" + dayOfMonth);
			}
